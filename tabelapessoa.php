...
<!--colocar a tabela-->
    <div class="container">
	   ...
	   "40818")or die ("Não foi possivel conectar ao BD");
		...
		echo ("<center><form action='tabelapessoa.php' method='post'>
		...
		{
			$FILTRO = $_POST['filtro'];
			$SQL = "SELECT * FROM pessoa WHERE nome_pessoa like '%$FILTRO%';";
		}			
		else
	...
	while ($linha = mysql_fetch_assoc($resultado))
	{
		...
		echo("	<td>".$ID."</td>
				...
				<td><a href='pessoa.php?id=$ID'>
				<img src='inserir.png' title='Adicionar'>
				</a>
				</td>
				<td><a href='tela_altera_pessoa.php?id=$ID'>
				<img src='editar.png' title='Editar'>
				</a>
				</td>
				<td><a href='tabelapessoa.php?id=$ID'>
