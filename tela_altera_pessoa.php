...
?>
  ...
  <!-- Contact Form -->
        ...
        <div class="row">
            <div class="col-md-8">
                <h3>Editar Pessoa</h3>
                <form name="sentMessage" id="contactForm"  action="altera_pessoa.php" method="POST" novalidate>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Nome Pessoa:</label>
                            <input type="text" class="form-control" id="name" name="nome_pessoa" value='<?php echo ($NOME_PESSOA) ?>'required data-validation-required-message="Por favor entre com o nome da etapa.">
